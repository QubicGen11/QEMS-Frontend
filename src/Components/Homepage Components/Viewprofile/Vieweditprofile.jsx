            ...
            >
                <form action="#!" className="row gy-3 gy-xxl-4">
                    <div className="col-12" bis_skin_checked={1}>
                        <div className="row gy-2" bis_skin_checked={1}>
                            <label className="col-12 form-label m-0" cursorshover="true">
                                Profile Image
                            </label>
                            <div className="col-12" bis_skin_checked={1}>
                                <img
                                    ...
                                    className="img-fluid"
                                    alt="Sajid Hussian"
                                    style={{width:'150px',borderRadius:'90px'}}
                                />
                            </div>
                            <div className="col-12" bis_skin_checked={1}>
                                <a
                    ...
                    <div className="col-12 col-md-6" bis_skin_checked={1}>
                    ...
                    <div className="col-12 col-md-6" bis_skin_checked={1}>
                        ...
                        <input
                            ...
                            className="form-control"
                            id="inputEmail"
                            defaultValue="sajid@qubicgen.com"
                        />
                    </div>
                    <div className="col-12 col-md-6" bis_skin_checked={1}>
                        ...
                        <input
                            ...
                            className="form-control"
                            id="inputAddress"
                            defaultValue="Mountain View, Bengaluru"
                        />
                    </div>
                    <div className="col-12 col-md-6" bis_skin_checked={1}>
