                    ...
                    <table className="min-w-full divide-y divide-gray-200 text-black:divide-gray-700">
                      <thead className="bg-gray-50 text-black:bg-gray-800">
                        <tr>
                          <th
                            scope="col"
                            className="py-3.5 px-4 text-sm font-normal text-left rtl:text-right text-gray-500 text-black:text-gray-400"
                          >
                            <div className="flex items-center gap-x-3">
                              <input
                                type="checkbox"
                          ...
                          <th
                            scope="col"
                            className="px-12 py-3.5 text-sm font-normal text-left rtl:text-right text-gray-500 text-black:text-gray-400"
                          >
                          ...
                          <th
                            scope="col"
                            className="px-4 py-3.5 text-sm font-normal text-left rtl:text-right text-gray-500 text-black:text-gray-400"
                          >
                            <button className="flex items-center gap-x-2">
                              <span>Role</span>
                              <svg
                      ...
                      <tbody className="bg-white divide-y divide-gray-200 text-black:divide-gray-700 text-black:bg-gray-900">
                        <tr>
                          ...
                          <td className="relative px-12 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                            <div
                              className={`inline-flex items-center px-3 py-1 rounded-full gap-x-2 cursor-pointer ${getStatusClasses(
                                status
                              )}`}
                              onClick={() => setIsOpen(!isOpen)}
                            >
                              <span
                                className={`h-1.5 w-1 rounded-full ${getStatusClasses(
                                  status
                                )}`}
                              />
                              <h2
                                className={`text-sm font-normal ${getStatusClasses(
                                  status
                                )}`}
                              >
                                {status}
                            ...
                            {isOpen && (
                              <div className="absolute z-10 mt-2 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 focus:outline-none">
                                <div className="py-1">
                                  <a
                                    href="#"
                          ...
                          <td className="px-4 py-4 text-sm whitespace-nowrap">
                            <div className="flex items-center gap-x-2">
                              <p className="px-3 py-1 text-xs text-indigo-500 rounded-full text-black:bg-gray-800 bg-indigo-100/60">
                                Design
                              </p>
                              <p className="px-3 py-1 text-xs text-blue-500 rounded-full text-black:bg-gray-800 bg-blue-100/60">
                                Product
                              </p>
                              <p className="px-3 py-1 text-xs text-pink-500 rounded-full text-black:bg-gray-800 bg-pink-100/60">
                                Marketing
                              </p>
                            </div>
                          </td>
